...
public class COTSFalconSwerveConstants {
    ...
    public static COTSFalconSwerveConstants SDSMK3(double driveGearRatio){
        ...
        return new COTSFalconSwerveConstants(wheelDiameter, angleGearRatio, driveGearRatio, angleKP, angleKP, angleKD, angleKF, driveMotorInvert, angleMotorInvert, canCoderInvert);
    }
