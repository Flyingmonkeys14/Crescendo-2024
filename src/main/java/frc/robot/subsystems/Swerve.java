...
import edu.wpi.first.math.geometry.Translate2d;
...
public class Swerve extends SubsystemBase {
    ...
    public Swerve() {
        ...
        gyro.setYaw(0);
             ...
             * See https://gitub.com/Team364/BaseFalconSwerve/issues/8 for more info
             */
            Timer.delay(2.0);
    ...
    public void drive(Translation2d translate, double rotation, boolean fieldRelative, boolean isOpenLoop) {
    ...
    public Rotation2d getYaw(){
        //return (Constants.Swerve.invertGyro) ? Rotations2d.fromDegrees(360 - gyro.getAngle()) : Rotation2d.fromDegrees(gyro.getAngle())
